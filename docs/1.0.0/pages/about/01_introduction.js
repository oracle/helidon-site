...
<v-card-text class="caption">
<p>A flexible configuration framework with support for multiple sources and formats.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
...
<li>
<p>Helidon MP: a more declarative model that supports the <a id="" title="" target="_blank" href="https://microprofile.io">MicroProfile</a>
...
<h3 id="_docker_and_kubernetes_support">Docker and Kubernetes support</h3>
<div class="section">
