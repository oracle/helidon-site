...
<p>As discussed in the section on <router-link to="/grpc/32_mp_server_side_services">Server-Side Services</router-link> there are four different types of gRPC method.</p>
...
file but there are many other ways to use and override <router-link to="/config/01_introduction">configuration in Helidon</router-link></p>
...
public class Client {
    ...
    @Inject                                  <span class="conum" data-value="1" />
    @GrpcServiceProxy                        <span class="conum" data-value="2" />
...
<li data-value="2">The <code>@GrpcServiceProxy</code> annotation is used by the CDI container to match the injection point to the gRPC MP APIs provider</li>
