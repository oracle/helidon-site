...
<v-card-text>
<dl>
<dt slot=title>Metrics MP Guide</dt>
...
<tr>
<td><a id="" title="" target="_blank" href="https://github.com/helm/helm">Helm</a></td>
</tr>
</tbody>
</table>
</div>
...
<markup
lang="bash"
title="Get the Helidon <code>grpc.requests.meter</code> metric:"
>curl -H "Accept: application/json"  http://localhost:8080/metrics/vendor/grpc.requests.meter</markup>
...
<div class="admonition note">
<p class="admonition-inline">You cannot get the individual fields of a metric. For example, you cannot target <a id="" title="" target="_blank" href="http://localhost:8080/metrics/vendor/grpc.requests.meter.count">http://localhost:8080/metrics/vendor/grpc.requests.meter.count</a>.</p>
</div>
</div>
...
<div class="section">
<p>There are three metrics that you can use by annotating a method:</p>
...
<markup
lang="java"
title="Update the <code>GreetApplication</code> class as follows:"
>@Override
public Set&lt;Class&lt;?&gt;&gt; getClasses() {
    return CollectionsHelper.setOf(GreetResource.class, GreetingCards.class); <span class="conum" data-value="1" />
}</markup>

<ul class="colist">
<li data-value="1">Add the <code>GreetingCards</code> class to the set of classes managed by Helidon for this application.</li>
</ul>
<markup
lang="bash"
...
<div class="section">
<p>The <code>@Timed</code> and <code>@Metered</code> annotations can also be used with a method.  For the following example. you can just annotate the same method with these metrics.
When using multiple annoations on a method, you <strong>must</strong> give the metrics different names as shown below.</p>
