...
<v-card-text>
<dl>
<dt slot=title>Config SE Guide</dt>
...
methods as described in <router-link to="/config/03_hierarchical-features">Hierarchical Config</router-link> and <router-link to="/config/06_advanced-configuration">Advanced Config</router-link>.</p>


<h5 id="_accessing_config_using_keys_or_navigation">Accessing config using keys or navigation</h5>
<div class="section">
...
See <router-link to="/config/05_mutability-support">Config Mutability Support</router-link> for a full discussion on this topic.
