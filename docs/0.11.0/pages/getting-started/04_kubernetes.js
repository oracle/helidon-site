...
<h2 id="_continue_with_the_quickstart_example">Continue with <router-link :to="{path: '/getting-started/02_base-example', hash: '#deploy-to-k8s'}">the quickstart example</router-link></h2>
<div class="section">
