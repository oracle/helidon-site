...
<tbody>
<tr>
<td class="">io.helidon.security.providers</td>
<td class="">Maven artifactId</td>
<td class="">helidon-security-providers-jwt</td>
</tr>
<tr>
<td class="">Provider package</td>
<td class="">io.helidon.security.providers.jwt</td>
<td class="">Provider class</td>
</tr>
<tr>
<td class="">JwtProvider</td>
...
<tr>
<td class="">atn-token/jwk.resource.*</td>
...
<tr>
<td class="">sign-token/jwk.resource.*</td>
...
<tr>
<td class="">sign-token/outbound/jwt-not-before-seconds</td>
<td class="">5</td>
...
<tr>
<td class="">sign-token/outbound/jwt-validity-seconds</td>
<td class="">1 day</td>
...
<tbody>
<tr>
<td class="">Maven groupId</td>
<td class="">io.helidon.security.providers</td>
</tr>
<tr>
<td class="">Maven artifactId</td>
<td class="">helidon-security-providers-http-auth</td>
</tr>
<tr>
<td class="">Provider package</td>
<td class="">io.helidon.security.providers.httpauth</td>
</tr>
<tr>
<td class="">Provider class</td>
<td class="">HttpBasicAuthProvider</td>
</tr>
<tr>
<td class="">Provider key</td>
<td class="">http-basic-auth</td>
</tr>
</tbody>
</table>
</div>
...
<td class="">realm</td>
<td class=""> helidon</td>
<td class="">Authentication realm - may be shown to user by browser</td>
</tr>
<tr>
<td class="">principal-type</td>
<td class="">USER</td>
<td class="">Type of subject authenticated by this provider - USER or SERVICE</td>
</tr>
<tr>
<td class="">users</td>
<td class="">none</td>
<td class="">A list of users (login, password and roles). Currently to externalize this you must use builder approach.</td>
</tr>
</tbody>
</table>
</div>
...
clear text to show its value (see <router-link to="#microprofile/06_configuration.adoc" @click.native="this.scrollFix('#microprofile/06_configuration.adoc')">Configuration Secrets</router-link>)</p>
...
<tr>
<td class="">Provider class</td>
<td class="">HttpDigestAuthProvider</td>
</tr>
<tr>
<td class="">Provider key</td>
<td class="">http-digest-auth</td>
</tr>
</tbody>
</table>
</div>
...
<td class="">MD5</td>
<td class="">Only MD5 supported</td>
</tr>
<tr>
<td class="">nonce-timeout-millis</td>
<td class="">1 day</td>
<td class="">Number of milliseconds for the nonce timeout</td>
</tr>
<tr>
<td class="">server-secret</td>
<td class="">random</td>
...
<td class="">qop</td>
<td class="">NONE</td>
<td class="">only AUTH supported. If left empty, uses the legacy approach (older RFC version). AUTH-INT is not supported.</td>
</tr>
</tbody>
</table>
</div>
...
<tr>
<td class="">Maven artifactId</td>
<td class="">helidon-security-providers-header</td>
</tr>
<tr>
<td class="">Provider package</td>
<td class="">io.helidon.security.providers.header</td>
</tr>
<tr>
<td class="">Provider class</td>
<td class="">HeaderAtnProvider</td>
</tr>
<tr>
<td class="">Provider key</td>
<td class="">header-atn</td>
</tr>
</tbody>
</table>
</div>
...
<td class="">optional</td>
<td class=""> false</td>
<td class="">If set to true, provider will abstain rather then fail if header not available</td>
</tr>
<tr>
<td class="">authenticate</td>
<td class="">true</td>
<td class="">If set to false, authentication will not be attempted</td>
</tr>
<tr>
<td class="">propagate</td>
<td class="">true</td>
<td class="">If set to false, identity propagation will not be done</td>
</tr>
<tr>
<td class="">principal-type</td>
<td class="">USER</td>
<td class="">Can be USER or SERVICE</td>
</tr>
<tr>
<td class="">atn-token</td>
<td class="">none</td>
...
<tr>
<td class="">outbound-token</td>
<td class="">atn-token</td>
<td class="">If outbound token should be created differently than inbound</td>
</tr>
</tbody>
</table>
</div>
...
<h5 id="_interaction_with_sub_resource_locators">Interaction with sub-resource locators</h5>
<div class="section">
