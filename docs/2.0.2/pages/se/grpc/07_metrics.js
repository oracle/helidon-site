...
<v-card-text>
<dl>
<dt slot=title>gRPC Service Metrics</dt>
...
<p>See <router-link to="#metrics/01_metrics.adoc" @click.native="this.scrollFix('#metrics/01_metrics.adoc')">Helidon Metrics</router-link> documentation for more details.</p>
