...
<tr>
<td>atn-token.verify-signature</td>
<td>true</td>
<td>Whether to verify signature in incoming JWT. If disabled, <em>ANY</em> JWT will be accepted</td>
</tr>
<tr>
<td>atn-token.jwt-audience</td>

<td>Expected audience of the JWT. If not defined, any audience is accepted (and we may accept JWT not inteded for us)</td>
</tr>
<tr>
<td>atn-token/jwk.resource.*</td>

<td>Configuration of the JWK to obtain key(s) to validate signatures of inbound token. The JWK should contain public keys. This may be: jwk.resource.path, jwk.resource.resource-path, jwk.resource.url, jwk.resource.content-plain (actual JSON string), jwk.resource.content (base64)</td>
</tr>
<tr>
