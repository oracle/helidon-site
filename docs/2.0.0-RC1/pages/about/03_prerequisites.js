...
<tr>
<td class=""><a id="" title="" target="_blank" href="https://kubernetes.io/docs/tasks/tools/install-kubectl/">Kubectl 1.11.9+</a></td>
</tr>
</tbody>
</table>
</div>
...
<p>Now you are ready to try the
 <router-link to="#_getting_started" @click.native="this.scrollFix('#_getting_started')">Quickstart Examples</router-link>.</p>
