...
offers two programming models: <router-link to="/se/introduction/01_introduction">Helidon SE</router-link>
and Helidon MP.</p>
...
Helidon 2.0.0-RC1 supports MicroProfile 3.2. Since
...
<p>For more information see <router-link to="/mp/guides/01_overview">guides</router-link>.</p>
...
<router-link to="/mp/extensions/01_overview">CDI extensions</router-link> to address areas not
