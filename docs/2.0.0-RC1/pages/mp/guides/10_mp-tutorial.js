...
<p>Helidon MP applications are packaged into a JAR file and the dependencies
 ...
 <router-link to="#guides/30_dockerfile.adoc" @click.native="this.scrollFix('#guides/30_dockerfile.adoc')">Creating Docker Images</router-link> page.</p>
...
<p class="admonition-inline">You can learn more about options for configuring the Helidon Server on the
 <router-link to="#microprofile/02_server-configuration.adoc" @click.native="this.scrollFix('#microprofile/02_server-configuration.adoc')">Configuring the Server</router-link> page.</p>
</div>
...
<p class="admonition-inline">To learn more about Helidon MP configuration please see the
 <router-link to="#config/01_introduction.adoc" @click.native="this.scrollFix('#config/01_introduction.adoc')">Config</router-link> section of the documentation.</p>
</div>
</div>
...
<p>Learn more about using Helidon and MicroProfile metrics in the <router-link to="#guides/09_metrics_mp_guide.adoc" @click.native="this.scrollFix('#guides/09_metrics_mp_guide.adoc')">Metrics Guide</router-link>.</p>
...
<p>Learn more about health checks in the <router-link to="#guides/07_health_mp_guide.adoc" @click.native="this.scrollFix('#guides/07_health_mp_guide.adoc')">Health Check Guide</router-link>.</p>
...
<p>Learn more about creating Docker images for Helidon applications at
 <router-link to="#guides/30_dockerfile.adoc" @click.native="this.scrollFix('#guides/30_dockerfile.adoc')">Creating Docker Images</router-link>.</p>
...
<li>
<p><router-link to="#guides/30_dockerfile.adoc" @click.native="this.scrollFix('#guides/30_dockerfile.adoc')">Creating Docker Images</router-link></p>

</li>
<li>
<p><router-link to="#microprofile/02_server-configuration.adoc" @click.native="this.scrollFix('#microprofile/02_server-configuration.adoc')">Configuring the Server</router-link></p>

</li>
<li>
<p><router-link to="#config/01_introduction.adoc" @click.native="this.scrollFix('#config/01_introduction.adoc')">Config</router-link></p>
...
<li>
<p><router-link to="#guides/09_metrics_mp_guide.adoc" @click.native="this.scrollFix('#guides/09_metrics_mp_guide.adoc')">Metrics Guide</router-link></p>
