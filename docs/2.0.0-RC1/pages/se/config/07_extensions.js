...
<p>The <router-link to="#config/01_introduction.adoc" @click.native="this.scrollFix('#config/01_introduction.adoc')">config system introduction</router-link> explains the design of the config
...
<li>
<p><code>ConfigSourceProvider</code> - support for named config sources, configurable through meta configuration</p>

</li>
<li>
<p><code>ChangeWatcherProvider</code> - support for named change watchers, configurable through meta configuration</p>

</li>
<li>
<p><code>OverrideSourceProvider</code> - support for named override sources, configurable through meta configuration</p>

</li>
<li>
<p><code>PollingStrategyProvider</code> - support for named polling strategies, configurable through meta configuration</p>

</li>
<li>
<p><code>RetryPolicyProvider</code> - support for retry policies, configurable through meta configuration</p>
...
<p>Other extensions are only used from Java service loader when you use meta configuration.
...
<p>Considering the following meta configuration:</p>
...
First provider that returns <code>true</code> when <code>supports("my-type")</code> is called would be used, and an instance of a <code>ConfigSource</code> created using <code>create("my-type", config)</code>, where <code>config</code> is located on the node of <code>properties</code> from meta configuration.</p>
...
<p>To support custom override sources in meta configuration, also implement the
...
<p>To support polling strategies that can be configured in meta configuration, also implement the <code>PollingStrategyProvider</code> Java service loader SPI.</p>
...
<p>To support change watchers that can be configured in meta configuration, also implement the <code>ChangeWatcherProvider</code> Java service loader SPI.</p>
...
<p>To support retry policies in meta configuration, also implement the Java service loader SPI
