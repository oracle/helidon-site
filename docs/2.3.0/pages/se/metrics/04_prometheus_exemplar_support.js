...
<dd slot="desc"><p>Add Helidon SE support for  <a id="" title="" target="_blank" href="https://github.com/OpenObservability/OpenMetrics/blob/main/specification/OpenMetrics.md#exemplars">OpenMetrics (Prometheus) exemplars</a> for histograms, counters, and simple timers to your application simply by adding dependencies to your project&#8217;s <code>pom.xml</code>.</p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<p>Also, include either <a id="" title="" target="_blank" href="../../shared/tracing/tracer-zipkin.adoc">Helidon Zipkin</a> or <a id="" title="" target="_blank" href="../../shared/tracing/tracer-jaeger.adoc">Helidon Jaeger</a> support:</p>
