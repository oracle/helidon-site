...
<div class="section">
<p>An easy way to start with the <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/Config.html">Config</a> API
is to follow these four steps:</p>

<ol style="margin-left: 15px;">
<li>
<router-link to="#add-maven-coords" @click.native="this.scrollFix('#add-maven-coords')">add config-related dependencies to your <code>pom.xml</code></router-link>
...
<h4 id="add-maven-coords">Add Maven Dependency on Config</h4>
<div class="section">
<p>Add <router-link to="#maven-coordinates" @click.native="this.scrollFix('#maven-coordinates')">config-related dependencies</router-link> to your `pom.xml.</p>
