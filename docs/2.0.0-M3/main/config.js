...
function createRoutes(){
    return [
        ...
        },
        {
            ...
            meta: {
                h1: 'Helidon SE Introduction',
                title: 'Helidon SE Introduction',
                h1Prefix: null,
        ...
        },
        {
            ...
            component: loadPage('se-cors-02_configuration', '/se/cors/02_configuration', {})
        },
        {
            path: '/se/dbclient/01_introduction',
            meta: {
                h1: 'Helidon DB Client',
        ...
        },
        {
            ...
            meta: {
                h1: 'Helidon WebClient',
                title: 'Helidon WebClient',
                h1Prefix: null,
        ...
        {
            path: '/mp/cors/02_configuration-with-cors-mp',
            meta: {
                h1: 'Using Configuration for CORS',
                title: 'Using Configuration for CORS',
                h1Prefix: null,
            ...
            component: loadPage('mp-cors-02_configuration-with-cors-mp', '/mp/cors/02_configuration-with-cors-mp', {})
        },
        {
        ...
        {
            path: '/mp/security/02_configuration-secrets',
            meta: {
            ...
            component: loadPage('mp-security-02_configuration-secrets', '/mp/security/02_configuration-secrets', {})
        },
        {
            path: '/mp/tracing/07_tracing',
            meta: {
                h1: 'Tracing',
                title: 'Tracing',
                h1Prefix: null,
            ...
            component: loadPage('mp-tracing-07_tracing', '/mp/tracing/07_tracing', {})
        },
        {
        ...
        {
            path: '/common/guides/jlink_image',
            meta: {
                h1: 'Custom Runtime Images with `jlink`',
                title: 'Custom Runtime Images with `jlink`',
                h1Prefix: null,
            ...
            component: loadPage('common-guides-jlink_image', '/common/guides/jlink_image', {})
        },
        {
            path: '/shared/reactivestreams/02_engine',
            meta: {
                h1: 'Reactive Engine',
            ...
            component: loadPage('shared-reactivestreams-02_engine', '/shared/reactivestreams/02_engine', {})
        },
        {
        ...
        {
            path: '/common/guides/maven_build',
            meta: {
                h1: 'Maven Guide',
                title: 'Maven Guide',
                h1Prefix: null,
            ...
            component: loadPage('common-guides-maven_build', '/common/guides/maven_build', {})
        },
        {
            path: '/guides/32_jib',
            meta: {
        ...
        {
            path: '/common/guides/graalnative',
            meta: {
                h1: 'GraalVM Native Images',
                title: 'GraalVM Native Images',
                h1Prefix: null,
            ...
            component: loadPage('common-guides-graalnative', '/common/guides/graalnative', {})
        },
        {
            path: '/common/guides/gradle_build',
            meta: {
                h1: 'Gradle Guide',
                title: 'Gradle Guide',
                h1Prefix: null,
            ...
            component: loadPage('common-guides-gradle_build', '/common/guides/gradle_build', {})
        },
        {
            path: '/shared/reactivestreams/03_rsoperators',
            meta: {
                h1: 'Reactive Streams Operators',
                title: 'Reactive Streams Operators',
                h1Prefix: null,
            ...
            component: loadPage('shared-reactivestreams-03_rsoperators', '/shared/reactivestreams/03_rsoperators', {})
        },
        {
...
function createNav(){
    return [
        ...
        { header: 'Helidon SE' },
        {
            ...
            items: [
                { href: '/se/introduction/01_introduction', title: 'Helidon SE Introduction' }
            ]
        },
        {
            title: 'Guides',
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/se/cors/02_configuration', title: 'Using Configuration for CORS' }
            ]
        },
        {
            title: 'DB Client',
            ...
            group: '/se/dbclient',
            items: [
                { href: '/se/dbclient/01_introduction', title: 'Helidon DB Client' }
            ]
        },
        {
            title: 'gRPC server',
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/se/metrics/02_prometheus', title: 'Prometheus Metrics' }
            ]
        },
        {
            title: 'OpenAPI',
        ...
        },
        {
            ...
            group: '/se/webclient',
            items: [
                { href: '/se/webclient/01_introduction', title: 'Helidon WebClient' }
            ]
        },
        {
            title: 'Websocket',
        ...
        { header: 'Helidon MP' },
        {
            ...
            items: [
                { href: '/mp/introduction/01_introduction', title: 'About Helidon MP' },
                { href: '/mp/introduction/02_microprofile', title: 'MicroProfile Introduction' }
            ]
        },
        {
            title: 'Guides',
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/mp/cors/02_configuration-with-cors-mp', title: 'Using Configuration for CORS' }
            ]
        },
        {
            title: 'gRPC server',
        ...
        },
        {
            ...
            group: '/mp/jpa',
            items: [
                { href: '/mp/jpa/01_introduction', title: 'JPA' }
            ]
        },
        {
            title: 'JWT Auth',
            ...
            group: '/mp/jwtauth',
            items: [
                { href: '/mp/jwtauth/01_introduction', title: 'JWT Auth' }
            ]
        },
        {
            title: 'Metrics',
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/mp/security/02_configuration-secrets', title: 'Configuration Secrets' }
            ]
        },
        {
            title: 'Tracing',
            ...
            group: '/mp/tracing',
            items: [
                { href: '/mp/tracing/07_tracing', title: 'Tracing' }
            ]
        },
        {
            title: 'Websocket',
