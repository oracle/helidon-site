...
<h1 id="_maven_guide">Maven Guide</h1>
<div class="section">
<p>This guide describes Helidon&#8217;s support for Maven projects.</p>
...
<div class="section">
<p>Helidon examples and projects generated using the <router-link to="/mp/guides/02_quickstart">Helidon Quickstart</router-link>
...
<a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/2.0.0-M3/examples/quickstarts/helidon-standalone-quickstart-mp">standalone quickstart example</a>.
...
<ol style="margin-left: 15px;">
<li>
native-image: Build a <router-link to="/mp/guides/36_graalnative">GraalVM native image</router-link>.

</li>
<li>
jlink-image:  Build a <router-link to="/mp/guides/37_jlink_image">custom runtime Java image</router-link>.
