...
<div class="section">
<p>Helidon examples and projects generated using the <router-link to="#{helidon-lc-flavor}/guides/02_quickstart.adoc" @click.native="this.scrollFix('#{helidon-lc-flavor}/guides/02_quickstart.adoc')">Helidon Quickstart</router-link>
...
<a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/2.0.0-M3/examples/quickstarts/helidon-standalone-quickstart-{helidon-lc-flavor}">standalone quickstart example</a>.
...
<a id="" title="" target="_blank" href="https://github.com/oracle/helidon/blob/2.0.0-M3/docs-internal/application-pom.md">Helidon&#8217;s Application POMS</a></p>
...
<ol style="margin-left: 15px;">
<li>
native-image: Build a <router-link to="#{helidon-lc-flavor}/guides/36_graalnative.adoc" @click.native="this.scrollFix('#{helidon-lc-flavor}/guides/36_graalnative.adoc')">GraalVM native image</router-link>.

</li>
<li>
jlink-image:  Build a <router-link to="#{helidon-lc-flavor}/guides/37_jlink_image.adoc" @click.native="this.scrollFix('#{helidon-lc-flavor}/guides/37_jlink_image.adoc')">custom runtime Java image</router-link>.
