...
<div class="section">
<p>Generate the project using the Helidon {helidon-uc-flavor} Quickstart Maven archetype.</p>
...
>mvn archetype:generate -DinteractiveMode=false \
    ...
    -Dpackage=io.helidon.examples.quickstart.{helidon-lc-flavor}</markup>

<p>The archetype generates a Maven project in your current directory
(for example, <code>helidon-quickstart-{helidon-lc-flavor}</code>). Change into this directory and build.</p>
...
>java -jar target/helidon-quickstart-{helidon-lc-flavor}.jar</markup>
...
<router-link to="#{helidon-lc-flavor}/guides/02_quickstart.adoc" @click.native="this.scrollFix('#{helidon-lc-flavor}/guides/02_quickstart.adoc')">Helidon {helidon-uc-flavor} quickstart Guide</router-link>.</p>
...
<p>The <code>target/helidon-quickstart-{helidon-lc-flavor}</code> directory is a self contained
...
>./target/helidon-quickstart-{helidon-lc-flavor}/bin/start</markup>
...
>docker build -t helidon-quickstart-{helidon-lc-flavor}-jlink -f Dockerfile.jlink .</markup>
...
>docker run --rm -p 8080:8080 helidon-quickstart-{helidon-lc-flavor}-jlink:latest</markup>
...
consider using <router-link to="#{helidon-lc-flavor}/guides/36_graalnative.adoc" @click.native="this.scrollFix('#{helidon-lc-flavor}/guides/36_graalnative.adoc')">GraalVM Native Images</router-link>.</p>
