...
function createRoutes(){
    return [
        ...
        },
        {
            ...
            component: loadPage('se-cli-01_cli', '/se/cli/01_cli', {})
        },
        {
        ...
        },
        {
            ...
            component: loadPage('mp-cli-01_cli', '/mp/cli/01_cli', {})
        },
        {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            group: '/se/cli',
                            items: [
                                { href: '/se/cli/01_cli', title: 'Helidon CLI' }
                            ]
                        },
                        {
                            title: 'Config',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            group: '/mp/cli',
                            items: [
                                { href: '/mp/cli/01_cli', title: 'Helidon CLI' }
                            ]
                        },
                        {
                            title: 'Config',
