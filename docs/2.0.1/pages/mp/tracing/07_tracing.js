...
<markup
lang="properties"
title="Example <code>microprofile-config.properties</code> with minimal tracer configuration"
>tracing.service=helidon-mp</markup>
...
Tracer tracer = req.webServer().configuration().tracer();</markup>
