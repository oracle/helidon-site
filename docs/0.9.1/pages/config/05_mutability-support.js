...
<h2 >Using Config Metadata</h2>
<div class="section">

<h3 >Loading Time</h3>
<div class="section">
<p>The config system records when it loads each configuration into memory.
Your application can retrieve it by invoking the <a id=""
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/Config.html#timestamp">timestamp method</a>:</p>
...
<div class="section">
<p>The config system maintains a <a id=""
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/Config.Context.html"><code>Config.Context</code></a>
...
<h2 >Responding to Changes in Config Sources</h2>
<div class="section">
...
<h3 >Setting up Config Source Change Detection</h3>
<div class="section">
...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/spi/PollingStrategy.html"><code>PollingStrategy</code></a> for each
config source you want to monitor. See the section on
<a id=""
title=""
target="_blank"
href="07_extensions.html#Config-SPI-PollingStrategy">polling strategies</a> in the
...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/PollingStrategies.html"><code>PollingStrategies</code></a> class:</p>
...
<h3 >Registering a Config Change Response</h3>
<div class="section">
...
<p>Each <code>Config</code> instance exposes the <a id=""
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/Config.html#changes"><code>Config.changes()</code></a>
...
<h2 >Accessing Always-current Values</h2>
<div class="section">
...
Supplier&lt;String&gt; greetingSupplier = config.get("greeting")                     <span class="conum" data-value="1" />
        .asStringSupplier();                                                   <span class="conum" data-value="2" />
...
<p ><p>Supplier support requires that you build the <code>Config</code> object from sources that
