...
<p>Also, include either <router-link to="/se/tracing/02_zipkin">Helidon Zipkin</router-link> or <router-link to="/se/tracing/03_jaeger">Helidon Jaeger</router-link> support:</p>
