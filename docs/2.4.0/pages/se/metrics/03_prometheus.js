...
<p>Note that Helidon has an in-built metrics implementation. See <router-link to="#metrics/01_metrics.adoc" @click.native="this.scrollFix('#metrics/01_metrics.adoc')">Helidon Metrics</router-link>.</p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<div class="section">
<p>To enable Prometheus Metrics
