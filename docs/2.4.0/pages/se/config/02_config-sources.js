...
<router-link :to="{path: '/se/config/01_introduction', hash: '#config-sources-default-config'}">config introduction</router-link>.</p>
...
the <router-link to="/se/config/07_extensions">extensions</router-link> documentation for complete information.</p>

<p>See the <router-link to="/se/config/06_advanced-configuration">advanced topics</router-link> page for further
...
The config system includes several built-in parsers, such as for the Java properties, YAML, JSON, and HOCON formats. See <router-link :to="{path: '/se/config/01_introduction', hash: '#built-in-formats'}">this section in
