...
<router-link :to="{path: '/se/config/06_advanced-configuration', hash: '#Config-Advanced-Config-MetaConfig'}">meta-configuration</router-link>
...
<p>You can also implement your own polling strategy by implementing
...
the <router-link to="/se/config/05_mutability-support">mutability support</router-link> and
<router-link :to="{path: '/se/config/07_extensions', hash: '#Config-SPI-PollingStrategy'}">polling strategy</router-link> discussions.</p>
