...
<li>
does not begin or end with a <code>'_'</code> character

</li>
<li>
does not contain <code>"__"</code>

</li>
<li>
contains one or more <code>'_'</code> characters
...
<ol style="margin-left: 15px;">
<li>
Replace any <code>"_dash_"</code> or <code>"_DASH_"</code> substrings with <code>"-"</code>, e.g. <code>"APP_PAGE_dash_SIZE"</code>
becomes <code>"APP_PAGE-SIZE"</code>.

</li>
<li>
Replace <code>'_'</code> with <code>'.'</code> and add as an alias, e.g. <code>"APP_GREETING"</code> is
...
<code>"app.someCamelCaseKey"</code>.
...
as configuration. See the <router-link to="/se/config/02_config-sources">config sources</router-link> section
...
<div class="section">
<p>This section is now available in <router-link to="/se/config/09_config-profiles">config profiles</router-link>,
 which make meta-configuration obsolete - you can achieve the same with less configuration.
A profile file is a meta-configuration file selected by the rules defined in the link above.</p>
...
<div class="section">
<p>The <router-link to="/se/config/01_introduction">introduction</router-link> section shows how to use
...
only if the classpath includes the corresponding parsers. The introduction section on <router-link :to="{path: '/se/config/01_introduction', hash: '#built-in-formats'}">built-in formats</router-link>
...
<div class="section">
<p>This section is now available in <router-link :to="{path: '/se/config/09_config-profiles', hash: '#Config-Profile-Format'}">config profile format</router-link></p>
...
<div class="section">
<p>As described in the <router-link :to="{path: '/se/config/03_hierarchical-features', hash: '#accessByKey'}">hierarchical features
...
<router-link :to="{path: '/se/config/07_extensions', hash: '#Config-SPI-ConfigFilter'}">filters</router-link> and
<router-link :to="{path: '/se/config/07_extensions', hash: '#Config-SPI-OverrideSource'}">overrides</router-link>.</p>
