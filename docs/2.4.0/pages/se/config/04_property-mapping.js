...
<router-link :to="{path: '/se/config/01_introduction', hash: '#app-properties'}"><code>application.properties</code></router-link> configuration
...
<div class="section">
<p>The <router-link to="/se/config/03_hierarchical-features">hierarchical features</router-link> section describes
...
config entry and the value is its <code>String</code> value</p>
...
<h4 id="WebConfig">Continuing the <code>Web</code> Example</h4>
<div class="section">
<p>The following examples build on the example configuration from the
<router-link :to="{path: '/se/config/01_introduction', hash: '#create-simple-config-props'}"><code>application.properties</code></router-link>
...
<p>Continuing with the <router-link to="#WebConfig" @click.native="this.scrollFix('#WebConfig')">WebConfig</router-link> example introduced earlier:</p>
