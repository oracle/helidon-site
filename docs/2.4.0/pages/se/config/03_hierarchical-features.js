...
<router-link :to="{path: '/se/config/08_supported-formats', hash: '#Config-ModuleHocon'}">extension module</router-link>.</p>
...
<p>For example, the <router-link :to="{path: '/se/config/01_introduction', hash: '#create-simple-config-props'}"><code>application.properties</code></router-link>
