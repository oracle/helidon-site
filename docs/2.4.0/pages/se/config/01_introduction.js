...
<li>
<p>using a <router-link to="/se/config/09_config-profiles">config profile</router-link> to choose the sources to be used</p>

</li>
<li>
<p>creating a <router-link :to="{path: '/se/config/06_advanced-configuration', hash: '#Config-Advanced-metaconfig'}">meta-configuration</router-link>
...
<td class=""><router-link to="/se/config/02_config-sources">Config sources</router-link>,<router-link to="/se/config/09_config-profiles">Config Profiles</router-link>,
<router-link :to="{path: '/se/config/06_advanced-configuration', hash: '#Config-Advanced-metaconfig'}">meta-configuration</router-link></td>
</tr>
<tr>
<td class="">What format config data is expressed in</td>
<td class=""><router-link :to="{path: '/se/config/02_config-sources', hash: '#parsers'}">Config parsers</router-link>,
<router-link to="/se/config/08_supported-formats">supported formats</router-link></td>
</tr>
<tr>
<td class="">How to filter, override, and dereference values</td>
<td class=""><router-link :to="{path: '/se/config/06_advanced-configuration', hash: '#filters-and-overrides'}">Filters and overrides</router-link></td>
</tr>
<tr>
<td class="">What happens when config data changes</td>
<td class=""><router-link :to="{path: '/se/config/05_mutability-support', hash: '#polling'}">Config polling</router-link></td>
</tr>
<tr>
<td class="">How to deal with loading errors</td>
<td class=""><router-link :to="{path: '/se/config/02_config-sources', hash: '#retry'}">Config retry policies</router-link></td>
</tr>
</tbody>
</table>
</div>
...
<td class=""><router-link to="/se/config/04_property-mapping">Config mappers</router-link></td>
</tr>
<tr>
<td class="">How to navigate config trees</td>
<td class=""><router-link to="/se/config/03_hierarchical-features">Navigation</router-link></td>
</tr>
</tbody>
</table>
</div>
...
<td class=""><router-link to="/se/config/07_extensions">Extensions</router-link></td>
</tr>
</tbody>
</table>
</div>
