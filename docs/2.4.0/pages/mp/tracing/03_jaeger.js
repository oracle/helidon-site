...
<h2 id="_integrating_with_jaeger_tracing">Integrating with Jaeger Tracing</h2>
<div class="section">
<p>Jaeger tracks its own behavior using metrics. See <router-link to="/mp/tracing/04_jaeger_metrics">Metrics Support for Jaeger</router-link> to read how to integrate Jaeger metrics with Helidon.</p>
