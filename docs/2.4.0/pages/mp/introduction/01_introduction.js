...
<div class="section">
<p>Helidon MP 2.4.0 is an implementation of the
...
<v-card-text class="caption">
<p></p>
<p>Work with JPA in Helidon MP in all the ways that you’re familiar with.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/mp/lra/01_introduction"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">pending_actions</v-icon>
</v-avatar>
</v-layout>
<div class="px-3">
<v-divider class="indigo lighten-4"/>
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Long Running Actions</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Distributed transactions for microservices following SAGA pattern.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
