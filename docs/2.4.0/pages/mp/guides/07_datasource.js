...
<v-card-text>
<dl>
<dt slot=title>Helidon MP Data Source Guide</dt>
...
<h3 id="_inject_a_datasource_into_your_application_code">Inject a Datasource into Your Application Code</h3>
<div class="section">
<div class="admonition note">
<p class="admonition-inline">For more information about datasources, see <a id="" title="" target="_blank" href="https://docs.oracle.com/javase/8/docs/api/javax/sql/DataSource.html">https://docs.oracle.com/javase/8/docs/api/javax/sql/DataSource.html</a></p>
</div>
...
<h3 id="_use_the_injected_datasource">Use The Injected DataSource</h3>
<div class="section">
<p>Now that you have a <code>DataSource</code>, you&#8217;ll use it to connect to the database.</p>

<p>First, ensure the <code>io.helidon.example.ds.ExampleResource</code> resource
...
<div class="section">
<p>Helidon features a few examples of projects that use datasources.</p>

<ul class="ulist">
<li>
<p><a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/2.4.0/examples/integrations/cdi/datasource-hikaricp-h2">An
example showing a Hikari connection pool data source connected to an
H2 database</a></p>

</li>
<li>
<p><a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/2.4.0/examples/integrations/cdi/datasource-hikaricp-mysql">An
