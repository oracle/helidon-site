...
<p>Check the documentation for a specific component to find out whether that component uses metrics and whether it allows you to disable that use.
If you disable a component&#8217;s use of metrics, Helidon does not register the component&#8217;s metrics in the visible metrics registries nor do those metrics ever update their values. The response from the <code>/metrics</code> endpoint excludes that component&#8217;s metrics.</p>
...
<h3 id="_metrics_metadata_2">Metrics Metadata</h3>
<div class="section">
<p>Each metric has associated metadata that describes:</p>
...
<h3 id="_integration_with_kubernetes_and_prometheus_2">Integration with Kubernetes and Prometheus</h3>
<div class="section">

<h4 id="_kubernetes_integration_2">Kubernetes Integration</h4>
<div class="section">
<p>The following example shows how to integrate the Helidon MP application with Kubernetes.</p>
...
<h4 id="_prometheus_integration_2">Prometheus Integration</h4>
<div class="section">
<p>The metrics service that you just deployed into Kubernetes is already annotated with <code>prometheus.io/scrape:</code>.  This will allow
Prometheus to discover the service and scrape the metrics.  In this exercise, you will install Prometheus
into Kubernetes, then verify that it discovered the Helidon metrics in your application.</p>
...
<h4 id="_final_cleanup_2">Final Cleanup</h4>
<div class="section">
<p>You can now delete the Kubernetes resources that were just created during this example.</p>
