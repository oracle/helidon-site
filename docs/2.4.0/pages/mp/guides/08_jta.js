...
<v-card-text>
<dl>
<dt slot=title>Helidon MP JTA Guide</dt>
<dd slot="desc"><p>This guide shows how to configure and use
<a id="" title="" target="_blank" href="https://jakarta.ee/specifications/transactions/1.3/">Java Transaction API
...
<h2 id="_add_the_helidon_jta_integration_to_your_applications_runtime_classpath">Add the Helidon JTA Integration to Your Application&#8217;s Runtime Classpath</h2>
<div class="section">
...
<h2 id="_add_jta_to_your_applications_compilation_classpath">Add JTA to Your Application&#8217;s Compilation Classpath</h2>
<div class="section">
...
<h2 id="_annotate_a_method_with_transactional">Annotate a Method With <a id="" title="" target="_blank" href="https://jakarta.ee/specifications/transactions/1.3/apidocs/javax/transaction/transactional"><code>@Transactional</code></a></h2>
<div class="section">
<p>Choose a method that you wish to have a certain kind of transactional
behavior, and annotate it with the
<a id="" title="" target="_blank" href="https://jakarta.ee/specifications/transactions/1.3/apidocs/javax/transaction/transactional"><code>@Transactional</code></a>
annotation.</p>
...
<a id="" title="" target="_blank" href="https://jakarta.ee/specifications/transactions/1.3/apidocs/javax/transaction/transactional.txtype#REQUIRED"><code>REQUIRED</code></a>
(which also happens to be the default if you do not specify an
explicit
<a id="" title="" target="_blank" href="https://jakarta.ee/specifications/transactions/1.3/apidocs/javax/transaction/transactional.txtype"><code>TxType</code></a>).</li>
