...
<div class="section">
<p>For this 30 minute tutrial, you&#8217;ll need the following:</p>
...
<tr>
<td class=""><a id="" title="" target="_blank" href="https://curl.se/download.html">curl</a></td>
<td class="">(Optional) for testing</td>
</tr>
</tbody>
</table>
</div>
...
<p class="admonition-inline">This guide assumes that you have read the following:
 <router-link to="/mp/guides/07_datasource">An understanding of named data source support in Helidon MP</router-link> and
 <router-link to="/mp/guides/08_jta">An understanding of transaction support in Helidon MP</router-link>.</p>
</div>
</div>
...
<h3 id="_add_the_h2_database_driver_to_the_runtime_classpath">Add the H2 Database Driver to the Runtime Classpath</h3>
<div class="section">
...
<h3 id="_add_the_hikari_connection_pool_extension_to_the_runtime_classpath">Add the Hikari Connection Pool Extension to the Runtime Classpath</h3>
<div class="section">
<p>Add the following dependency in your <code>pom.xml</code>:</p>
...
<h3 id="_add_the_jta_extension_to_the_runtime_classpath">Add the JTA Extension to the Runtime Classpath</h3>
<div class="section">
<p>Add the following dependency in your <code>pom.xml</code>:</p>
...
<h3 id="_add_the_provider_independent_helidon_jpa_extension_to_the_runtime_classpath">Add the Provider-Independent Helidon JPA Extension to the Runtime Classpath</h3>
<div class="section">
<p>Add the following dependency in your <code>pom.xml</code>:</p>
...
<h3 id="_add_the_eclipselink_jpa_extension_to_the_runtime_classpath">Add the EclipseLink JPA Extension to the Runtime Classpath</h3>
<div class="section">
<p>Add the following dependency in your <code>pom.xml</code>:</p>
...
<h3 id="_add_the_jta_and_jpa_dependencies_to_the_provided_classpath">Add the JTA and JPA Dependencies to the Provided Classpath</h3>
<div class="section">
...
<h3 id="_add_ddl_to_create_the_relevant_database_tables">Add DDL to Create the Relevant Database Tables</h3>
<div class="section">
...
<h3 id="_add_an_application_yaml_file_with_database_connectivity_information">Add an <code>application.yaml</code> File With Database Connectivity Information</h3>
<div class="section">
...
<h3 id="_add_a_java_class_to_represent_a_greeting_jpa_entity">Add a Java Class to Represent a Greeting JPA Entity</h3>
<div class="section">
...
<h3 id="_add_a_meta_infpersistence_xml_descriptor">Add a <code>META-INF/persistence.xml</code> Descriptor</h3>
<div class="section">
...
<h3 id="_modify_the_pom_xml_file_to_support_static_weaving">Modify the <code>pom.xml</code> File To Support Static Weaving</h3>
<div class="section">
