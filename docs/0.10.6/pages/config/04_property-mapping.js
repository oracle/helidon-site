...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/Config.html"><code>Config</code></a> class itself provides many
...
<td><code>boolean b = config.asBoolean();</code> <sup>2</sup></td><td><code>boolean defaultedB = config.asBoolean(true);</code> <sup>3</sup></td>
</tr>
<tr>
...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/ConfigMappers.html"><code>ConfigMappers</code></a> class
...
<router-link :to="{path: '/config/01_introduction', hash: '#app-properties'}"><code>application.properties</code></router-link> configuration
...
<div class="section">
<p>The <router-link to="/config/03_hierarchical-features">hierarchical features</router-link> section describes
...
<h3 id="_built_in_conversions_to_code_list_code_and_code_map_code">Built-in Conversions to <code>List</code> and <code>Map</code></h3>
<div class="section">
...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/Config.html">JavaDoc</a>
...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/package-summary.html#conversions"><code>io.helidon.config</code>
package JavaDoc</a>.</p>
...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/ConfigMapper.html"><code>ConfigMapper</code></a> class.
The difference is in how your application triggers the use of that mapper.</p>


<h4 id="_use_custom_mapper_explicitly_code_config_map_code_method">Use Custom Mapper Explicitly: <code>Config.map</code> method</h4>
<div class="section">
...
<h4 id="_register_custom_mapper_once_use_implicitly_code_config_as_code_method">Register Custom Mapper Once, Use Implicitly: <code>Config.as</code> method</h4>
<div class="section">
...
<h4 id="_continuing_the_code_web_code_example">Continuing the <code>Web</code> Example</h4>
<div class="section">
<p>The following examples build on the example configuration from the
<router-link :to="{path: '/config/01_introduction', hash: '#create-simple-config-props'}"><code>application.properties</code></router-link>
...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/Config.Value.html"><code>Config.Value</code></a> annnotation to control some of the JavaBean processing for a
given property.</p>
...
title=""
target="_blank"
href="./apidocs/index.html?io/helidon/config/Config.Transient.html"><code>Config.Transient</code></a>.</p>
...
<h4 id="addBuilderToTargetClass">Add <code>builder()</code> to Target Class</h4>
<div class="section">
...
<h4 id="writeSeparateBuilder">Write a Builder Separate from the Target Class</h4>
<div class="section">
