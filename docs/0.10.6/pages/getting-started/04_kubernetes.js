...
<h2 id="_continue_with_router_link_to_path_getting_started_02_base_example_hash_deploy_to_k8s_the_quickstart_example_router_link">Continue with <router-link :to="{path: '/getting-started/02_base-example', hash: '#deploy-to-k8s'}">the quickstart example</router-link></h2>
<div class="section">
