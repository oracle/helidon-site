...
<div class="section">
<p>Helidon MP 1.3.1 supports
MicroProfile 3.0. You can find the exact version of APIs supported on the
...
as is done in the
<router-link to="/guides/03_quickstart-mp">Helidon MP Quickstart example</router-link>
