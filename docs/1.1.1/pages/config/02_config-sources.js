...
<router-link :to="{path: '/config/01_introduction', hash: '#config-sources-default-config'}">config introduction</router-link>.</p>

<p>If instead your application uses a <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/Config.Builder.html"><code>Config.Builder</code></a>, then it can invoke one of the <code>sources</code> methods on that builder to set which config sources it should use.</p>
...
<p>See the JavaDoc for the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/ConfigSources.html"><code>ConfigSources</code></a>
...
<a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/spi/ConfigSource.html"><code>ConfigSource</code></a> interface. See
the <router-link to="/config/07_extensions">extensions</router-link> documentation for complete information.</p>

<p>See the <router-link to="/config/06_advanced-configuration">advanced topics</router-link> page for further
...
The config system includes several built-in parsers, such as for the Java properties, YAML, JSON, and HOCON formats. See <router-link :to="{path: '/config/01_introduction', hash: '#built-in-formats'}">this section in
...
<p>Even so, the config system allows your application to learn when such underlying changes in the data occur and respond accordingly. The <router-link to="/config/05_mutability-support">mutability</router-link> section explains this in detail, and the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/PollingStrategies.html"><code>PollingStrategies</code></a> JavaDoc describes the built-in implementations. You can, of course, write your own by implementing the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/spi/PollingStrategy.html"><code>PollingStrategy</code></a> interface. On a config source builder invoke <code>pollingStrategy</code> with an instance of your custom strategy and then invoke <code>build</code> to create the <code>ConfigSource</code>.</p>
...
<p>See the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/RetryPolicies.html"><code>RetryPolicies</code></a> JavaDoc for complete details on these built-in retry policies.</p>

<p>You can devise your own policy. Implement the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/spi/RetryPolicy.html"><code>RetryPolicy</code></a> interface. Then pass an instance of your policy implementation to the config source builder&#8217;s <code>retryPolicy</code> method.</p>
