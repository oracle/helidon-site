...
<h2 id="_the_restful_web_service_tutorial">The RESTful Web Service Tutorial</h2>
<div class="section">
...
<p>As you develop the app, this tutorial helps you understand what each part of the
...
public void update(Routing.Rules rules) {
    rules
        ...
        .put("/greeting/{greeting}", this::updateGreetingHandler); <span class="conum" data-value="3" />
}</markup>
...
<p>Later steps in this tutorial show how to add your own, app-specific health check and
metric.</p>
</div>
...
<div class="section">
<p>Instead of generating and then enhancing the application as described in this tutorial,
