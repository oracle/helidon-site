...
<p>Helidon SE includes a <a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/2.3.1/examples/openapi">complete OpenAPI example</a>
...
<div class="section">
<p>Add a dependency for <router-link to="#maven-coordinates" @click.native="this.scrollFix('#maven-coordinates')">Helidon SE OpenAPI</router-link> runtime support.
