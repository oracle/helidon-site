...
that can be used to run some basic examples using both built-in and custom metrics with Helidon SE.</p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<h4 id="_key_performance_indicator_kpi_metrics">Key Performance Indicator (KPI) Metrics</h4>
<div class="section">
...
<p>Your Helidon SE application can also control the behavior of the KPI metrics programmatically.</p>

<ol style="margin-left: 15px;">
<li>
Prepare a <code>KeyPerformanceIndicatorSettings</code> object, using its builder, and then pass the builder when invoking the <code>MetricsSupport.Builder#keyPerformanceIndicatorMetricsSettings()</code> method.

</li>
<li>
Prepare a <code>Config</code> object and pass it to the <code>MetricsSupport.Builder#keyPerformanceIndicatorMetricsConfig()</code> method.
<markup
lang="properties"
title="Example KPI metrics config fragment"
>extended = true
long-running.threshold-ms = 2000</markup>

</li>
</ol>
<p>Your Helidon SE application can also enable or disable the extended KPI metrics and control the long-running request threshold using methods on the <a id="" title="" target="_blank" href="./apidocs/io.helidon.metrics/io/helidon/metrics/MetricsSupport.Builder.html">MetricsSupport.Builder</a> class.</p>
