...
defined within the <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/spi/ConfigNode.html"><code>ConfigNode</code></a> interface.</p>
...
<tr>
<td class="">object</td>
<td class=""><code>ConfigNode.ObjectNode</code></td>
<td class="">Represents complex structure (a subtree). Its child nodes can be of
any type.</td>
</tr>
<tr>
<td class="">list</td>
<td class=""><code>ConfigNode.ListNode</code></td>
<td class="">Represents a list of nodes. Its components can be of any type.</td>
</tr>
<tr>
<td class="">value</td>
<td class=""><code>ConfigNode.ValueNode</code></td>
<td class="">Represents a leaf node.</td>
</tr>
</tbody>
</table>
</div>
...
<router-link to="#Config-ModuleHocon" @click.native="this.scrollFix('#Config-ModuleHocon')">extension module</router-link>.</p>
...
<td class="">object<br>
value</td>
<td class="">member name of the node within its parent</td>
</tr>
<tr>
<td class="">list</td>
<td class="">element index of the node within the containing list</td>
</tr>
</tbody>
</table>
</div>
...
<a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/Config.html#name--"><code>name</code></a>,
 <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/Config.html#key--"><code>key</code></a>, and
 <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/Config.html#type--"><code>type</code></a> of the
 node.</p>
...
<tbody>
<tr>
<td class=""><code>exists</code></td>
<td class="">Returns <code>true</code> or <code>false</code></td>
</tr>
<tr>
<td class=""><code>ifExists</code></td>
<td class="">Execute functional operations for present nodes</td>
</tr>
<tr>
<td class=""><code>type</code></td>
<td class="">Returns enum value for the <code>Config.Type</code>; <code>Config.Type.MISSING</code> if the node
represents a config value that <em>does not</em> exist</td>
</tr>
<tr>
<td class=""><code>as</code></td>
<td class="">Returns the <code>ConfigValue</code> with the correct type that has all methods of <code>Optional</code>
    and a few additional ones - see <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/ConfigValue.html"><code>ConfigValue</code></a> interface.</td>
</tr>
</tbody>
</table>
</div>
...
<tbody>
<tr>
<td class=""><code>asNodeList()</code></td>
<td class="">Returns a ConfigValue&lt;List&lt;Config&gt;&gt;. For nodes of type <code>OBJECT</code> contains child nodes as a <code>List</code>.</td>
</tr>
<tr>
<td class=""><code>hasValue()</code></td>
<td class="">For any node reports if the node has a value. This can be true for
any node type except <code>MISSING</code>.</td>
</tr>
<tr>
<td class=""><code>isLeaf()</code></td>
<td class="">Reports whether the node has no child nodes. Leaf nodes have no children
and has a single value.</td>
</tr>
<tr>
<td class=""><code>key()</code></td>
<td class="">Returns the fully-qualified path of the node using dotted notation.</td>
</tr>
<tr>
<td class=""><code>name()</code></td>
<td class="">Returns the name of the node (the last part of the key).</td>
</tr>
<tr>
<td class=""><code>asNode()</code></td>
<td class="">Returns a <code>ConfigValue&lt;Config&gt;</code> wrapped around the node</td>
</tr>
<tr>
<td class=""><code>traverse()</code><br>
<code>traverse(Predicate&lt;Config&gt;)</code></td>
<td class="">Returns a <code>Stream&lt;Config&gt;</code> as an iterative
deepening depth-first traversal of the subtree</td>
</tr>
<tr>
<td class=""><code>type()</code></td>
<td class="">Returns the <code>Type</code> enum value for the node: <code>OBJECT</code>, <code>LIST</code>, <code>VALUE</code>,
...
<p>For example, the <router-link to="#create-simple-config-props" @click.native="this.scrollFix('#create-simple-config-props')"><code>application.properties</code></router-link>
...
<a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/Config.html#detach--"><code>Config.detach</code></a> method it gets back
