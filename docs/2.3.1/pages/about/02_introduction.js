...
<p class="admonition-inline">The <router-link to="/about/03_prerequisites">Helidon Quickstart Examples</router-link>
...
<div class="section">
<p>Try the <router-link to="/about/03_prerequisites">Helidon Quickstart Examples</router-link>.</p>
