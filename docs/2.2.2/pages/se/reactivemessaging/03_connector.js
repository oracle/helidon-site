...
Supplied <router-link to="/se/config/01_introduction">Heldion Config</router-link> is merged with
...
<div class="section">
<p>Implicit config without any hard-coding is possible with <router-link to="/se/config/01_introduction">Heldion Config</router-link>  following notation of <a id="" title="" target="_blank" href="https://download.eclipse.org/microprofile/microprofile-reactive-messaging-1.0/microprofile-reactive-messaging-spec.html#_configuration">MicroProfile Reactive Messaging</a>.</p>
