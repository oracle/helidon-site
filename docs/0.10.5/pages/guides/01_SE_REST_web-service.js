...
<h3 id="_create_your_application">Create Your Application</h3>
<div class="section">
...
<h4 id="_update_your_code_pom_xml_code">Update Your <code>pom.xml</code></h4>
<div class="section">

<h5 id="_the_essentials">The Essentials</h5>
<div class="section">
...
<h5 id="_to_run_code_maven_code_outside_your_ide">To Run <code>maven</code> Outside your IDE</h5>
<div class="section">
...
>    private static final Config CONFIG = Config.create().get("app"); <span class="conum" data-value="1" />
    private String greeting = CONFIG.get("greeting").asString("Ciao"); <span class="conum" data-value="2" /></markup>
...
>    private static Routing createRouting() {
        ...
        return Routing.builder()
                .register(JsonSupport.get()) <span class="conum" data-value="2" />
...
<li>
<p>liveness - often a more thorough assessment of if
...
<p>Our greeting service does not depend on any
...
<h4 id="_add_code_to_code_greetservice_java_code">Add code to <code>GreetService.java</code></h4>
<div class="section">
...
<h4 id="_add_code_to_code_main_java_code">Add code to <code>Main.java</code></h4>
<div class="section">
<p>Now let&#8217;s add the code to actually implement the readiness and liveness endpoints to
to the <code>Main</code> class.</p>

<p>Along the way, you or your IDE will need to add</p>
...
<h4 id="_rebuild_and_rerun_your_service">Rebuild and rerun your service</h4>
<div class="section">
<p>Follow the same steps you did before. Make sure you have stopped any earlier
instance of your service to free up the port.</p>
...
>{"error":"greeting is not set or is empty"}</markup>
...
<p>You or your IDE will add this import:</p>
...
<li>
Just after the invocation of <code>register(JsonSupport.get())</code>
add this
<markup
lang="java"
...
<p>You or your IDE will add these imports:</p>
...
<h4 id="_sends_some_requests">Sends some requests</h4>
<div class="section">
...
>Method=counterFilter Thread=nioEventLoopGroup-3-1</markup>
...
>Method=counterFilter Thread=nioEventLoopGroup-3-2</markup>
...
>Method=counterFilter Thread=nioEventLoopGroup-3-3</markup>
...
>Method=counterFilter Thread=nioEventLoopGroup-3-4</markup>
...
>"application":{"accessctr":4}</markup>
...
<h3 id="_or_download_the_example_source">(Or, Download the Example Source)</h3>
<div class="section">
