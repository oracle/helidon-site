...
function createRoutes(){
    return [
        ...
        {
            path: '/guides/01_SE_REST_web-service',
            meta: {
                h1: 'Creating a ReSTful Web Service using Helidon SE',
                title: 'Creating a ReSTful Web Service using Helidon SE',
                description: 'Helidon guide restful web service',
                keywords: 'helidon, guide, rest, web, service, example',
                customLayout: null,
                hasNav: true
            },
            component: loadPage('guides-01_SE_REST_web-service', '/guides/01_SE_REST_web-service', {})
        },
        {
...
function createNav(){
    return [
        ...
        },
        {
            ...
            group: '/guides',
            items: [
                { href: '/guides/01_SE_REST_web-service', title: 'Creating a ReSTful Web Service using Helidon SE' }
            ]
        },
        {
            title: 'Javadocs',
