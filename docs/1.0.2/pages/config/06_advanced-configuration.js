...
alphanumeric characters and underscore, this config source <em>adds</em> variants that
...
<p>Variants are produced for any environment variable name that matches <em>all</em> of
the following:</p>
...
<p>For each such name, two variants are added with the names mapped as follows:</p>

<ul class="colist">
<li data-value="1">Replace any <code>"_dash_"</code> substrings with <code>"-"</code>, e.g. <code>"APP_PAGE_dash_SIZE"</code>
becomes <code>"APP_PAGE-SIZE"</code>.</li>
<li data-value="2">Replace <code>'_'</code> with <code>'.'</code> and add as a variant, e.g. <code>"APP_GREETING"</code> is
...
<li data-value="3">Convert the result of step 2 to lowercase and add as a variant, e.g.
...
and the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/ConfigSources.html#file-java.lang.String-"><code>ConfigSources.file</code></a>
JavaDoc.</p>
...
already in memory. See the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/ConfigSources.html"><code>ConfigSources</code> javadoc</a>
...
<a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/ConfigSources.html#prefixed-java.lang.String-java.util.function.Supplier-"><code>ConfigSources.prefixed</code></a> method.
...
implementation of
<a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/ConfigSources.MergingStrategy.html"><code>ConfigSources.MergingStrategy</code></a>
...
<p>By default config source implementations use the Java Service
<code>java.nio.file.spi.FileTypeDetector</code> API to infer the source media type from
...
<ul class="ulist">
<li>
<p>invoking the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/ConfigSources.html#load-io.helidon.config.Config-"><code>ConfigSources.load(Config)</code></a>
method, passing a config object read from the meta-config source as the argument;</p>

</li>
<li>
<p>invoking the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/Config.html#loadSourcesFrom-java.util.function.Supplier&#8230;&#8203;"><code>Config.loadSourcesFrom</code></a>
method, or</p>

</li>
<li>
<p>invoking the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/Config.html#builderLoadSourcesFrom-java.util.function.Supplier&#8230;&#8203;"><code>Config.builderLoadSourceFrom</code></a>
method.</p>
...
<td><doc-view>
<p>Fully-qualified class name of either:<br></p>
...
<a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/internal/FileConfigSource.FileBuilder.html"><code>FileConfigSource.FileBuilder</code></a>.)</p>
...
<h5 id="_custom_source_types_using_class">Custom Source Types using <code>class</code></h5>
<div class="section">
...
<h5 id="_custom_source_type_using_type">Custom Source Type using <code>type</code></h5>
<div class="section">
...
Config config = Config.create(sourceFromMetaConfig);       <span class="conum" data-value="3" /></markup>
...
<td>Periodic polling - See <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/PollingStrategies.html#regular-java.time.Duration-"><code>PollingStrategies.regular</code></a> method</td>
<td><code>interval</code> (<code>Duration</code>) - indicating how often to poll; e.g., <code>PT15S</code> represents 15 seconds</td>
</tr>
<tr>
<td><code>watch</code></td>
<td>Filesystem monitoring - See <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/PollingStrategies.html#watch-java.nio.file.Path-"><code>PollingStrategies.watch</code></a> method</td>
...
<td>Regularly-scheduled - see <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/configRetryPolicies.html#repeat-int-"><code>RetryPolicies.repeat</code></a>.</td>
<td><doc-view>
...
See <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/spi/RetryPolicy.html"><code>RetryPolicy</code></a> and
<a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/spi/PollingStrategy.html"><code>PollingStrategy</code></a> JavaDoc
sections.</p>
...
<p>The built-in <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/ConfigFilters.html#valueResolving--">value-resolving</a>
filter enables the token substitution described below.</p>

<p>See the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/spi/ConfigFilter.html"><code>ConfigFilter</code></a> JavaDoc
...
<p>See the <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/spi/OverrideSource.html"><code>OverrideSource</a></code> JavaDoc
for more detail.</p>
...
<a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/ConfigSources.CompositeBuilder.html">CompositeBuilder</a>
...
a <a id="" title="" target="_blank" href="./apidocs/index.html?io/helidon/config/RetryPolicies.Builder.html">RetryPolicies.Builder</a>.
