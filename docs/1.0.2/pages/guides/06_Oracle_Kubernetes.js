...
<p>Then edit <code>src/main/k8s/app.yaml</code> and add the following under <code>spec</code> in the
 <code>deployment</code> section:</p>
...
<div class="admonition note">
<p class="admonition-inline">The file at <code>src/main/k8s/app.yaml</code> is configured as a Maven resource to
 allow for substituting Maven properties, the Maven build generates a substituted
 file at <code>target/app.yaml</code>.</p>
</div>
<markup
lang="bash"
