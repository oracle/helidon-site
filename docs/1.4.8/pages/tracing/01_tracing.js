...
<div class="listing">
<pre>GrpcTracingConfig tracingConfig = new GrpcTracingConfig.Builder()
                .withStreaming()
                .withVerbosity()
...
<td>The overall span of the Web Server from request intitiation until response
...
<td>Span for reading the request entity</td>
</tr>
<tr>
<td><code>web-server</code></td>
<td><code>content-write</code></td>
<td>Span for writing the response entity</td>
</tr>
<tr>
<td><code>security</code></td>
<td><code>security</code></td>
<td>Processing of request security</td>
</tr>
<tr>
<td><code>security</code></td>
<td><code>security:atn</code></td>
<td>Span for request authentication</td>
</tr>
<tr>
<td><code>security</code></td>
<td><code>security:atz</code></td>
<td>Span for request authorization</td>
</tr>
<tr>
<td><code>security</code></td>
<td><code>security:response</code></td>
<td>Processing of response security</td>
</tr>
<tr>
<td><code>security</code></td>
<td><code>security:outbound</code></td>
<td>Processing of outbound security</td>
</tr>
<tr>
<td><code>jax-rs</code></td>
<td>A generated name</td>
<td>Span for the resource method invocation, name is generated from class and method name</td>
</tr>
<tr>
<td><code>jax-rs</code></td>
<td><code>jersey-client-call</code></td>
<td>Span for outbound client call</td>
</tr>
</tbody>
</table>
</div>
...
<td>YES</td>
<td>YES</td>
<td>Each handler has its class and event logged</td>
</tr>
<tr>
<td><code>security</code></td>
...
<td>YES</td>
<td>YES</td>
<td>Logs either "status: PROCEED" or "status: DENY"</td>
</tr>
<tr>
<td><code>security:atn</code></td>
...
<td>YES</td>
<td>NO</td>
<td>The username of the user if logged in</td>
</tr>
<tr>
<td><code>security:atn</code></td>
<td><code>security.service</code></td>
<td>YES</td>
<td>NO</td>
<td>The name of the service if logged in</td>
</tr>
<tr>
<td><code>security:atn</code></td>
<td><code>status</code></td>
<td>YES</td>
<td>YES</td>
<td>Logs the status of security response (such as <code>SUCCESS</code>)</td>
</tr>
<tr>
<td><code>security:atz</code></td>
<td><code>status</code></td>
...
<td>name of the component - <code>helidon-webserver</code>, or <code>jaxrs</code> when using MP</td>
</tr>
<tr>
<td><code>HTTP Request</code></td>
<td><code>http.method</code></td>
<td>HTTP method of the request, such as <code>GET</code>, <code>POST</code></td>
</tr>
<tr>
<td><code>HTTP Request</code></td>
...
<td>The path of the request (for SE without protocol, host and port)</td>
</tr>
<tr>
<td><code>HTTP Request</code></td>
<td><code>error</code></td>
<td>If the request ends in error, this tag is set to <code>true</code>, usually accompanied by logs with details</td>
</tr>
<tr>
<td><code>content-read</code></td>
<td><code>requested.type</code></td>
<td>Type (class) of the requested entity (if entity is read)</td>
</tr>
<tr>
<td><code>content-write</code></td>
<td><code>response.type</code></td>
<td>Type (class) of the entity being sent (if enitty is sent)</td>
</tr>
<tr>
<td><code>security</code></td>
<td><code>security.id</code></td>
<td>ID of the security context created for this request (if security is used)</td>
</tr>
<tr>
<td><code>jersey-client-call</code></td>
<td><code>http.method</code></td>
<td>HTTP method of the client request</td>
</tr>
<tr>
<td><code>jersey-client-call</code></td>
<td><code>http.status_code</code></td>
<td>HTTP status code of client response</td>
</tr>
<tr>
<td><code>jersey-client-call</code></td>
<td><code>http.url</code></td>
<td>Full URL of the request (such as <code><a id="" title="" target="_blank" href="http://localhost:8080/greet">http://localhost:8080/greet</a></code>)</td>
</tr>
</tbody>
</table>
</div>
...
<p>Parameters provided:
1. Method - HTTP method
2. Path - path of the request (such as '/greet')
3. Query - query of the request (may be null)</p>
