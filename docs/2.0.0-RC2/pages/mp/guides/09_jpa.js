...
<tr>
<td class=""><router-link to="#guides/20_datasource.adoc" @click.native="this.scrollFix('#guides/20_datasource.adoc')">An understanding of named data source support in Helidon MP</router-link></td>
</tr>
<tr>
<td class=""><router-link to="#guides/22_jta.adoc" @click.native="this.scrollFix('#guides/22_jta.adoc')">An understanding of transaction support in Helidon MP</router-link></td>
</tr>
<tr>
