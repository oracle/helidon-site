...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/se/introduction/01_introduction"><div class="card__link-hover"/>
</router-link>
...
<span style="text-align:center">Helidon SE</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>A set of reactive, non-blocking libraries.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/mp/introduction/01_introduction"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">explore</v-icon>
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Helidon MP</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/about/03_prerequisites"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Get Started</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Get started with Helidon.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
