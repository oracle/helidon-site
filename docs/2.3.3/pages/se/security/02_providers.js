...
<p>In Helidon SE, we need to register the redirection support with
routing (in addition to <code>WebSecurity</code> that integrates with <code>WebServer</code>).
This is not required when <code>redirect</code> is set to false.</p>
