...
<div class="section">
<p>Jaeger tracks its own behavior using metrics. See <router-link to="/se/tracing/04_jaeger_metrics">Metrics Support for Jaeger</router-link> to read how to integrate Jaeger metrics with Helidon.</p>
