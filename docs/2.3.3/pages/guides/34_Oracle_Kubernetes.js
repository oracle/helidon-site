...
<tr>
<td class="">An OKE cluster. See the <a id="" title="" target="_blank" href="http://www.oracle.com/webfolder/technetwork/tutorials/obe/oci/oke-full/index.html">OKE documentation</a>.</td>
</tr>
<tr>
<td class="">A Helidon project created from the quickstart Maven archetype. See
 <router-link to="#guides/02_quickstart-se.adoc" @click.native="this.scrollFix('#guides/02_quickstart-se.adoc')">quickstart Maven archetype</router-link>.</td>
</tr>
</tbody>
</table>
</div>
