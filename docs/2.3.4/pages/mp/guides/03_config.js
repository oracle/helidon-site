...
introduction section at <router-link to="#config/01_introduction.adoc" @click.native="this.scrollFix('#config/01_introduction.adoc')">Helidon Config</router-link> has much more information.</p>
