...
Your application can retrieve it by invoking the <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/Config.html#timestamp--">timestamp method</a>:</p>
...
<div class="section">
<p>The config system maintains a <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/Config.Context.html"><code>Config.Context</code></a>
...
<tbody>
<tr>
<td class=""><code>Instant timestamp()</code></td>
<td class="">Returns the load time of the last loaded configuration
that used the context.</td>
</tr>
<tr>
<td class=""><code>Config last()</code></td>
<td class="">Returns the most recently loaded configuration that used the context.</td>
</tr>
<tr>
<td class=""><code>Config reload()</code></td>
<td class="">Reloads the
...
<a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/spi/PollingStrategy.html"><code>PollingStrategy</code></a> for each
config source you want to monitor. See the section on
<router-link to="#Config-SPI-PollingStrategy" @click.native="this.scrollFix('#Config-SPI-PollingStrategy')">polling strategies</router-link> in the
...
on the <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/PollingStrategies.html"><code>PollingStrategies</code></a> class:</p>
...
<p>Each <code>Config</code> instance exposes the <a id="" title="" target="_blank" href="./apidocs/io.helidon.config/io/helidon/config/Config.html#changes--"><code>Config.changes()</code></a>
