...
<dd slot="desc"><p>Integrate the metrics from Jaeger tracing into your Helidon SE application simply by adding a dependency.</p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<div class="section">
<p>As the <router-link to="/se/tracing/03_jaeger">Helidon Jaeger Tracing</router-link> document describes, you can use Jaeger tracing in your Helidon SE application.</p>
