...
<dd slot="desc"><p>Helidon integrates with <a id="" title="" target="_blank" href="https://projects.eclipse.org/projects/ee4j.tyrus">Tyrus</a> to provide support for the <a id="" title="" target="_blank" href="https://projects.eclipse.org/projects/ee4j.websocket">Jakarta WebSocket API</a>.
...
<p>The complete Helidon SE example is available <a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/master/examples/webserver/websocket">here</a>. Let us start by
...
reader see the <a id="" title="" target="_blank" href="https://projects.eclipse.org/projects/ee4j.websocket">websocket specification</a>; in this <a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/master/examples/webserver/websocket">example</a>,
 <code>UppercaseEncoder.class</code> simply uppercases every message sent from the server.</p>
