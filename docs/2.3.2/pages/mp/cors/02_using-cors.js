...
<li>
Add a dependency on the Helidon MP CORS <router-link to="#maven-coordinates" @click.native="this.scrollFix('#maven-coordinates')">artifact</router-link>  to your Maven <code>pom.xml</code> file.
...
<div class="section">
<p>In the <a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/2.3.2/examples/quickstarts/helidon-quickstart-mp">Helidon MP Quickstart application</a> you can change the greeting by sending a <code>PUT</code>
...
<li>
<p>See the Helidon CORS support in action by building and running the <a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/2.3.2/examples/microprofile/cors">CORS example</a>.</p>
